                                         ...
                                         boxPlus(
                                           ...
                                           accordion(
                                             ...
                                             accordionItem(
                                               ...
                                               color = "info",
                                               collapsed = TRUE,
                                               h4("In the 10-year survival prediction tabs, a Random Survival Forest Classifier Models can be generated using the selected inputs to predict 10-year breast cancer survival")
                                             ),
                                             accordionItem(
                                               id = 5,
